...
I have a few projects where, for historical reasons, I maintain the project task list in the project directory itself. The following directory local variable should be marked as safe in these projects.

#+begin_src emacs-lisp
  (add-to-list 'safe-local-variable-values
               '((org-refile-targets (nil :tag . "DONE"))))     
#+end_src
* Org Mode
