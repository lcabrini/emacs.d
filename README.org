...
#+begin_src emacs-lisp
  (setq org-agenda-files '("~/Appunti/gtd/projects.org"))
#+end_src
...
#+begin_src emacs-lisp
  (setq org-capture-templates '(("t" "Todo [inbox]" entry
                                 (file+headline "~/Appunti/gtd/inbox.org" "Inbox")
                                 "* TODO %i%?")))
#+end_src
...
#+begin_src emacs-lisp
  (use-package org-journal
    ...
    :config
    (setq org-journal-dir "~/Appunti/journal/"))
#+end_src
...
#+begin_src emacs-lisp
  (setq org-outline-path-complete-in-steps nil
        ...
        org-refile-targets '(("~/Appunti/gtd/projects.org" :level . 1)
                             ("~/Appunti/gtd/tasks.org" :level . 1)
                             ("~/Appunti/gtd/someday.org" :level . 1)
                             ("~/Appunti/gtd/freezer.org" :level . 1)
                             ("~/Appunti/gtd/archive.org" :level . 1)))
#+end_src
* Magit
...
#+end_src
* Odin
Support for the [[https://odin-lang.org/][Odin]] programming language. These are the packages I have found
that add Odin support to Emacs:
- [[https://github.com/mattt-b/odin-mode][odin-mode]]: major mod for Odin.
- [[https://github.com/mattt-b/flycheck-odin][flycheck-odin]]: Flycheck for Odin
- [[https://github.com/Sampie159/odin-ts-mode][odin-ts-mode]]: major mode for Odin (using tree-sitter)
- [[https://github.com/DanielGavin/ols][ols]]: LSP server for Odin

For the time being, I'm using odin-ts-mode. 
...
#+end_src
* Go
My configuration for the [[https://go.dev/][Go]] programming language, one of the languages that I use the most these days. To get
the formatting on save to work, make sure the =goimports= tool is installed.
...
#+end_src
* Yasnippet
[[https://github.com/joaotavora/yasnippet][Yasnippet]] is a package to provide snippets for Emacs.
